...
sprite_change_offset("walljump", 28, 29);
sprite_change_offset("pratfall", 28, 29);
sprite_change_offset("land", 28, 39);
sprite_change_offset("landinglag", 28, 39);
