...
sprite_change_offset("dattack_hurt", 58*2, 69*2);
...
sprite_change_offset("uair_hurt", 58*2, 89*2);
sprite_change_offset("dair", 58, 89);
sprite_change_offset("dair_hurt", 58*2, 89*2);
sprite_change_offset("wair", 57, 89);
sprite_change_offset("fstrong", 58, 89);
sprite_change_offset("fstrong_hurt", 58*2, 89*2);
...
sprite_change_offset("fspecial_hurt", 58*2, 89*2);
...
sprite_change_offset("uspecial_hurt", 58*2, 89*2);
